...
// ]
  ...
  public func get_icp_usd_exchange() : async Text {
    ...
    let url = "https://api.digitalocean.com/v2/snapshots"; //url = "https://" # host # "/products/ICP-USD/candles?start=" # Nat64.toText(start_timestamp) # "&end=" # Nat64.toText(start_timestamp) # "&granularity=" # Nat64.toText(ONE_MINUTE);
    let bearer_token : Text = "Bearer dop_v1_4d1dae6c36dac40a30a7263839e50f74b20552f5de258a46ec00922d1ebfa072";
    let req_val : Text = "application/json";
    ...
    let request_headers = [
        ...
        {  name = "Content-Type"; value = req_val },
